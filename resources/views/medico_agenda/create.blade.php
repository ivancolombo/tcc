                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="domingo" value="0" name="dias[]">
                                <label class="form-check-label" for="domingo">Domingo</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="segunda" value="1" name="dias[]">
                                <label class="form-check-label" for="segunda">Segunda</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="terca" value="2" name="dias[]">
                                <label class="form-check-label" for="terca">Terça</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="quarta" value="3" name="dias[]">
                                <label class="form-check-label" for="quarta">Quarta</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="quinta" value="4" name="dias[]">
                                <label class="form-check-label" for="quinta">Quinta</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="sexta" value="5" name="dias[]">
                                <label class="form-check-label" for="sexta">Sexta</label>
                            </div>
                            <div class="form-group form-check mb-1">
                                <input type="checkbox" class="form-check-input" id="sabado" value="6" name="dias[]">
